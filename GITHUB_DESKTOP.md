# FPSWatcher Next v1.2.4 — GitHub Desktop and Stable Release
...
7. Enter `1.2.4` in the version field and run the workflow.
8. The workflow creates the `v1.2.4` tag, publishes the latest GitHub Release, signs the APK/AAB files, and generates SHA-256 checksums.
